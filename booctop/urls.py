...
urlpatterns += i18n.i18n_patterns(
    ...
    url(r'^course/(?P<teacher_id>[0-9]+)/(?P<course_url>\w+)/ecommerce_payment/(?P<id>[0-9]+)/$', ecommerce_payment, name='ecommerce_payment'),
    ...
    url(r'^favorite/$', showFavList, name='show fav list'),
